...
def insert_weather(city, country, temperature, humidity, observation_date):
    try:
        ...
        insert_query = """
        INSERT INTO weather_info (city, country, temperature, humidity, observation_date)
        VALUES (%s, %s, %s, %s, %s)RETURNING weather_info_id;
        """
        cursor.execute(insert_query, (city, country, temperature, humidity, observation_date))
...
def get_all_observations():
    try:
        ...
        select_query = """
        SELECT city, country, temperature, humidity, observation_date
        FROM weather_info
...
def update_weather(obs_id, temperature, humidity):
    try:
        ...
        WHERE weather_info_id = %s;
         """
        cursor.execute(update_query, (temperature, humidity, obs_id))
